...
\section{Organisasjonsform}\label{sec:organisasjonsform}
Organisasjonen er en frittstående juridisk person med medlemmer, og er selveiende. At den er selveiende
innebærer at ingen, verken medlemmer eller andre, har krav på foreningens formue eller eiendeler,
eller er ansvarlig for gjeld eller andre forpliktelser.
...
\section{Signaturrett}\label{sec:signaturrett}
Signaturrett på vegne av organisasjonen skal gis til leder av organisasjonen pluss ett styremedlem i fellesskap. 
Dersom leder av org. ikke er tilgjengelig vil nestleder pluss ett styremedlem i fellesskap ha signaturrett.
